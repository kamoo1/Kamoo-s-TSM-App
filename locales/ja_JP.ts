...
<context>
    ...
    <message>
        ...
        <translation>⚠️ ローカルデータベースをGitHubのリモートデータベースで上書きします</translation>
    </message>
    <message>
        <location filename="../ah/ui/main_view.py" line="224"/>
        <source>⚠️ Remote Mode</source>
        <translation>⚠️ リモートモード</translation>
    </message>
    <message>
...
You can patch now by clicking &apos;Yes&apos; or pass by clicking &apos;No&apos; (you can always patch later by clicking &apos;Patch LibRealmInfo&apos; button in the &apos;Tools&apos; tab).</source>
        <translation>もし、TSM（TW、KR、あるいは一部のクラシックサーバーなど）が公式にサポートしていない地域やサーバーをエクスポートしている場合、それらのサーバーのサポートを追加するためにTSMの &apos;LibRealmInfo&apos; ライブラリをパッチすることをお勧めします。

これらのデータが不足していると、TSMはこれらのサーバーの地域を誤って認識し、オークションデータの読み込みに問題が発生する可能性があります。
