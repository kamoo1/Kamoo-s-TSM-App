...
<context>
    ...
    <message>
        ...
        <translation>⚠️ 로컬 데이터베이스를 GitHub의 원격 데이터베이스로 덮어쓰시겠습니까?</translation>
    </message>
    <message>
        <location filename="../ah/ui/main_view.py" line="224"/>
        <source>⚠️ Remote Mode</source>
        <translation>⚠️ 원격 모드</translation>
    </message>
    <message>
...
You can patch now by clicking &apos;Yes&apos; or pass by clicking &apos;No&apos; (you can always patch later by clicking &apos;Patch LibRealmInfo&apos; button in the &apos;Tools&apos; tab).</source>
        <translation>만약 당신이 TSM이 공식으로 지원하지 않는 지역과 서버 (TW, KR 또는 몇몇 클래식 서버와 같은)를 내보내고 있다면, TSM의 &apos;LibRealmInfo&apos; 라이브러리를 사용하여 이러한 서버를 지원하도록 패치하는 것을 권장합니다.

이러한 데이터의 부재는 TSM이 이 서버의 지역을 오작동하게 하여 경매 데이터 로딩 문제를 유발할 수 있습니다.
